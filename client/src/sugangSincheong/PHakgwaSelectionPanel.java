...
public class PHakgwaSelectionPanel extends JPanel {
	...
	public String update(Object source) throws Exception {
	...
	private class PDirectory extends JTable {
		...
		public String intialize(String fileName) throws Exception {
		...
		public String getModelData(String fileName) throws Exception {
