...
public class PGangjwaSelectionPanel extends JTable {
	...
	public void intialize(String hakgwaFileName, PResultPanel pMiridamgiPanel, PResultPanel pSincheongPanel) throws Exception {
	...
	public void update(String hakgwaFileName) throws Exception {
